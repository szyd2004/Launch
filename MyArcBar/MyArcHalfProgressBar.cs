...
namespace MyArcBar
{
    public partial class MyArcHalfProgressBar : UserControl
    {
        ...
        [Description("起始角度")]
        [Category("Behavior")]
        public int Startarg { get { return _Startarg; } set { _Startarg = value; this.Invalidate(); } }
        [EditorBrowsable(EditorBrowsableState.Always)]
        [Browsable(true)]
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            try
            {
                ...
                path.AddArc(_Pleft, _PTop, DrawWidth, DrawHeight, _Startarg,
                    persent);
                path.AddArc(_Pleft + _Pwidth, _PTop + _Pwidth,
                    DrawWidth - 2 * _Pwidth, DrawHeight - 2 * _Pwidth, _Startarg + persent, -persent);
