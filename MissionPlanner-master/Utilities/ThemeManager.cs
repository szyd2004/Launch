...
namespace MissionPlanner.Utilities
{
    ...
    public class ThemeManager
    {
        ...
        public static Color BGColor = Color.FromArgb(12, 21, 30);
        ...
        public static Color ControlBGColor = Color.FromArgb(12, 21, 30);
        ...
        private static void ApplyCustomTheme(Control temp, int level)
        {
            ...
            foreach (Control ctl in temp.Controls)
            {
                ...
                else if (ctl.GetType() == typeof(MyButton))
                {
                    ...
                    but.BGGradTop = Color.FromArgb(255, 229, 229, 229);
                    but.BGGradBot = Color.FromArgb(255, 229, 229, 229);
                    but.TextColor = Color.Black;
                    but.Outline = Color.FromArgb(255, 229, 229, 229);
                    but.ColorNotEnabled = Color.FromArgb(73, 0x2b, 0x3a, 0x03);
                    but.ColorMouseOver = Color.FromArgb(255, 219, 130, 58);
                    but.ColorMouseDown = Color.FromArgb(255, 219, 130, 58);                   
                    //but.BGGradTop = ButBG;
                    //try
                    //{
                ...
                else if (ctl.GetType() == typeof(DataGridView) || ctl.GetType() == typeof(MyDataGridView))
                {
                    ...
                    dgv.BackgroundColor = Color.FromArgb(12, 21, 30); ;
                ...
                {
                    ctl.BackColor = Color.FromArgb(12, 21, 30);
                    ctl.ForeColor = TextColor;
