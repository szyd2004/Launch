...
#if !PocketPC
                                       // Image MapnullImage = Image.FromFile("mapsmd.jpg");
                                        Image MapnullImage = Properties.Resources.mapbak;
                                        g.DrawImage(MapnullImage, Core.tileRect.X, Core.tileRect.Y, Core.tileRect.Width, Core.tileRect.Height);
