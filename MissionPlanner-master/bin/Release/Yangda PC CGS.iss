...
CreateAppDir=yes
OutputDir=.
OutputBaseFilename=LAUNCH GCS V1.1.7 
Compression=lzma
;WindowVisible=yes
FlatComponentsList=yes         
VersionInfoDescription=LAUNCH GCS V1.1.7
...
Name: "{userdesktop}\LAUNCH GCS V1.1.7";Filename: "{app}\LAUNCH GCS.exe"
