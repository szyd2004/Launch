    ...
    public partial class ConfigPlanner : MyUserControl, IActivate
    {
        ...
        public void Activate()
        {
            ...
            if (Settings.Instance["YangDa_connetUAVCheck"] != null)
            {
                ...
                {
                    check_connetUAV.Checked = false;
                }
                else
                    check_connetUAV.Checked = true;
            }
            else
                check_connetUAV.Checked = true;
            try
...
/*
        ...
        private void check_connetUAV_CheckedChanged(object sender, EventArgs e)
        {
            if (check_connetUAV.Checked)
                Settings.Instance["YangDa_connetUAVCheck"] = "1";
            else
